...
public class MemberService {
    ...
    public MemberInfoResponseDto findMemberInfoByMemberName(String memberName) {
        return memberRepository.findByMemberName(memberName)
                .map(Member -> MemberInfoResponseDto.from(Member))
                .orElseThrow(() -> new IllegalArgumentException("해당 사용자를 찾을 수 없습니다. member_name=" + memberName));
    }
}
